...
        // ✅ AÑADIDO: Log para éxito en el envío del mensaje de Telegram
        console.log(`SUCCESS: Mensaje de Telegram enviado para la transacción ${id_transaccion_generado}`);
...
                // ✅ AÑADIDO: Log para éxito en el envío del comprobante
                console.log(`SUCCESS: Comprobante de pago enviado para la transacción ${id_transaccion_generado}`);
            } catch (fileSendError) {
...
                // ✅ AÑADIDO: Log para éxito en la actualización de Supabase
                console.log(`SUCCESS: Supabase actualizado con message_id para la transacción ${id_transaccion_generado}`);
            }
        }
